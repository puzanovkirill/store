...
i_phone = Product.create(name: 'iPhone 12', price: 699, category_id: phones.id, brand_id: apple.id)
pixel = Product.create(name: 'Google Pixel 4', price: 449, category_id: phones.id, brand_id: google.id)
macbook = Product.create(name: 'MacBook Pro 13 M1', price: 1299, category_id: laptops.id, brand_id: apple.id)
matebook = Product.create(name: 'Huawei Matebook 13', price: 999, category_id: laptops.id, brand_id: huawei.id)
